...
export function MobileBoothCard({
  ...
  if (layout === "list") {
    return (
      <div
        className={`bg-white p-4 cursor-pointer transition-all hover:bg-gray-50 ${className}`}
  ...
  return (
    <div
      className={`bg-white rounded-xl shadow-sm border border-gray-100/50 overflow-hidden hover:shadow-lg transition-all duration-200 cursor-pointer group ${className}`}
      onClick={handleCardClick}
    >
      {/* 档口图片 */}
