...
const ShopSidebar: React.FC<ShopSidebarProps> = ({ booth }) => {
  ...
  return (
    <>
      <aside className="card-glass w-full md:w-[340px] p-6 flex flex-col items-center max-h-[388px] overflow-auto">
        {/* 头像 */}
        ...
        {!isMobile && (
          <div className="w-full mt-6">
            ...
            <ContactDialog
              ...
              booth={booth}
            />
            <SupplyDialog open={supplyOpen} onOpenChange={setSupplyOpen} />
          </div>
        )}
      </aside>
      {/* 移动端底部按钮 */}
